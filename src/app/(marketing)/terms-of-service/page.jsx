...
export const metadata = generatePageMetadata({
  ...
  description:
    "Read the terms and conditions that apply to bookings and website use across Five Clover Hotels Group.",
  path: "/terms-of-service",
  keywords: SEO_KEYWORDS.terms || ["terms and conditions", "Five Clover Hotels Group"],
});
      ...
      <div className="max-w-[110rem] mx-auto px-[6rem] max-md:px-[3rem] max-sm:px-[2rem] py-[10rem] font-secondary text-[color:var(--text-color)]">
        ...
        <ol className="flex flex-col gap-[4rem] text-2xl list-decimal list-inside">
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                this website, you agree to these Terms and Conditions. If
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                <strong>Booking Confirmation:</strong> Bookings made through
                this website or a linked property site are subject to
                availability and confirmation. Once a booking is confirmed,
                a confirmation email will be sent to the email address you
                provided during the booking process.
              </li>
              <li>
                <strong>Payment:</strong> Payment for bookings must be made
                on site, unless otherwise stated by the specific property.
              </li>
              <li>
                <strong>Cancellation Policy:</strong> Cancellations must be
                made in accordance with the cancellation policy of the
                property you booked with, as outlined on that property's
                booking page. Late cancellations or no-shows may be subject
                to a fee.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                ...
                including the use of drugs or the involvement in any
                unlawful conduct, are strictly prohibited on hotel premises.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                complete, or up to date. We reserve the right to make
                changes to the site's content, services, or prices at any
              ...
              <li>
                <strong>Third-Party Links:</strong> Our website contains
                links to the individual sites of our hotel properties and
                other third-party websites. Five Clover Hotels Group is not
                responsible for the content, services, or privacy practices
                of those sites. Visiting them is at your own risk.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                including text, images, graphics, and logos, is the
                property of Five Clover Hotels Group or its licensors and is
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                your own risk. Five Clover Hotels Group does not warrant
                that the website will be error-free or that access will be
                uninterrupted. The information provided is on an "as-is"
                basis.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Five Clover Hotels
                Group shall not be liable for any direct, indirect,
                incidental, consequential, or punitive damages arising from
                your use of the website, bookings, or a stay at any of our
                properties.
              </li>
            </ul>
          </li>
