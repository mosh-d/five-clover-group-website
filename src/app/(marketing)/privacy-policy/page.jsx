...
export const metadata = generatePageMetadata({
  ...
  description:
    "Read Five Clover Hotels Group's privacy policy to learn how we collect, use, and protect your personal information.",
  path: "/privacy-policy",
  keywords: SEO_KEYWORDS.privacy || ["privacy policy", "Five Clover Hotels Group"],
});
    ...
    <main>
      <div className="max-w-[110rem] mx-auto px-[6rem] max-md:px-[3rem] max-sm:px-[2rem] py-[10rem] font-secondary text-[color:var(--text-color)]">
        ...
        <p className="text-2xl mb-[5rem]">
          At Five Clover Hotels Group, we are committed to protecting your
          privacy and ensuring the security of your personal information.
          This Privacy Policy outlines how we collect, use, and safeguard
          your data when you visit our website, make a booking, or interact
          with us in any way.
        </p>
        ...
        <ol className="flex flex-col gap-[4rem] text-2xl list-decimal list-inside">
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                Communicate with you regarding your reservation, inquiries,
                or special requests.
              </li>
              <li>
              ...
              <li>
                ...
                discounts, or upcoming events across the Five Clover Hotels
                Group (if you have opted in to receive such communications).
              </li>
              <li>
                Comply with legal obligations, prevent fraud, and protect
                our business.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <p className="mt-[1.5rem]">
              ...
              including the individual sites of our hotel properties. Five
              Clover Hotels Group is not responsible for the privacy
              practices or content of those sites. We encourage you to
              review the privacy policies of those sites before providing
          ...
          <li>
            ...
            <p className="mt-[1.5rem]">
              ...
              changes in our practices or for legal, technical, or
